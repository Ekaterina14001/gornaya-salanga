      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
                    ...
                    : _error != null
                        ...
                        : Column(
                            ...
                            children: [
                              ...
                              Text(l10n.balance, style: Theme.of(context).textTheme.titleMedium),
            ...
            _QuickLink(icon: Icons.wb_sunny_outlined, title: l10n.weather, onTap: () => context.push('/weather')),

            _QuickLink(icon: Icons.downhill_skiing, title: l10n.trails, onTap: () => context.push('/trails')),

            _QuickLink(icon: Icons.videocam_outlined, title: l10n.webcams, onTap: () => context.push('/webcams')),

            _QuickLink(icon: Icons.notifications_outlined, title: l10n.notifications, onTap: () => context.push('/notifications')),

            _QuickLink(icon: Icons.contact_mail_outlined, title: l10n.contact, onTap: () => context.push('/contact')),
